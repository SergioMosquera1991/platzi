...
class PostControllerTest extends TestCase
{
    ...
    public function test_validate_tilte()
    {
        $user = factory(User::class)->create();
        ...
        $response->assertStatus(422)//Estatus http 422 esta hecha pero fue imposible completar
    ...
    {
        $this->json('GET', '/api/posts')->assertStatus(401); //No estamos autorizados al acceso
